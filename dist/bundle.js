...
var validators = {
  ...
  email: function email() {
    return function (text) {
      var label = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'email';

      var valid = emailRegex.test(text);
  ...
  length: function length() {
    var _length = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5;

    return function (text) {
      var label = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Value';

      var valid = typeof text === 'string' && text.length >= _length;
      return valid ? null : prettify(label) + ' must be ' + _length + ' or more characters.';
    };
  },
  ...
  presence: function presence() {
    return function (text, label) {
      return text ? null : label ? prettify(label) + ' is required.' : 'Missing required fields.';
    };
  },
   ...
   */
  equalsField: function equalsField(fieldKey) {
    var fieldLabel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : fieldKey;
    return function (text, textLabel, state) {
      return text === state[fieldKey] ? null : prettify(textLabel) + ' must equal ' + prettify(fieldLabel) + '.';
    };
  },
   ...
   */
  differsFromField: function differsFromField(fieldKey) {
    var fieldLabel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : fieldKey;
    var customMessage = arguments[2];
    return function (text, textLabel, state) {
      return text === state[fieldKey] ? customMessage || prettify(textLabel) + ' must be different from ' + prettify(fieldLabel) + '.' : null;
    };
  },
   ...
   */
  multiple: function multiple(arrayOfValidators) {
    return function (text, label, state) {
      return arrayOfValidators.map(function (v) {
        return v(text, label, state);
      }).find(function (v) {
        return v;
      }) || null;
    };
  ...
  phone: function phone() {
    return function (text) {
      return phoneRegex.test(text) ? null : 'Please enter a complete 10-digit phone number, with area code.';
    };
  },
  ...
  website: function website() {
    return function (text) {
      return websiteRegex.test(text) ? null : 'Please enter a valid website URL.';
    };
  }
};
...
function formatKey(key) {
  var titleize = function titleize(list) {
    return list.map(function (w, i) {
      return i === 0 ? (0, _lodash.capitalize)(w) : w;
    }).join(' ');
  };
  if (key.includes('-')) {
    ...
    return titleize((0, _lodash.kebabCase)(key).split('-'));
  }
}
...
exports.setDropdownValues = setDropdownValues;
exports.setOpenDropdownID = setOpenDropdownID;
exports.setRadioValue = setRadioValue;
exports.setCheckboxValue = setCheckboxValue;
exports.cognitoSignOut = cognitoSignOut;
exports.setCarouselIndex = setCarouselIndex;
exports.setActiveBreakpoint = setActiveBreakpoint;
 ...
 */
function setDropdownValues(id, values) {
  return {
    type: 'SET_DROPDOWN_VALUES', id: id, values: values
  };
}
 ...
 * @return     {Object} Action object
 */
function setOpenDropdownID(id) {
  return {
    type: 'SET_OPEN_DROPDOWN_ID', id: id
  };
}
 ...
 * @return     {Object} Action object
 */
function setRadioValue(groupID, item) {
  return {
    type: 'SET_RADIO_VALUE', groupID: groupID, item: item
  };
}
 ...
 * @return     {Object} Action object
 */
function setCheckboxValue(boxID, value) {
  return {
    type: 'SET_CHECKBOX_VALUE', boxID: boxID, value: value
  };
}
...
function setCarouselIndex(carouselID, index) {
  return {
    type: 'SET_CAROUSEL_INDEX', carouselID: carouselID, index: index
  };
}
 ...
 * @return {Object} Action object
 */
function setActiveBreakpoint(breakpointName, breakpointSize, queryState) {
  return {
    type: 'SET_ACTIVE_BREAKPOINT', breakpointName: breakpointName, breakpointSize: breakpointSize, queryState: queryState
  };
}
...
function setActiveModal(modalID) {
  return {
    type: 'SET_ACTIVE_MODAL', modalID: modalID
  };
}
 ...
 * @return     {Object}  Action object
 */
function setExpanded(section, name) {
  return {
    type: 'SET_EXPANDED', section: section, name: name
  };
}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(81), __webpack_require__(127)(module)))
...
var _BaseForm = __webpack_require__(183);
...
var _RadioGroup = __webpack_require__(299);
...
exports.BaseFormUC = undefined;

var _stringify = __webpack_require__(184);
 ...
 */
var BaseFormUC = exports.BaseFormUC = function (_React$Component) {
  (0, _inherits3.default)(BaseFormUC, _React$Component);

  function BaseFormUC(props) {
    (0, _classCallCheck3.default)(this, BaseFormUC);

    var _this = (0, _possibleConstructorReturn3.default)(this, (BaseFormUC.__proto__ || (0, _getPrototypeOf2.default)(BaseFormUC)).call(this, props));

    _this.state = _this.initialState(props.fields);
    return _this;
  }

  (0, _createClass3.default)(BaseFormUC, [{
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      if (newProps.clearForm && !this.props.clearForm) {
        ...
        (0, _lodash.flatten)(newProps.fields).forEach(function (field) {
          var value = _this2.state[field.stateKey];
    ...
    key: 'initialState',
    value: function initialState(passedFields) {
      var fields = passedFields || this.props.fields;
      var formErrors = {};

      var state = fields.reduce(function (obj, fieldRow) {
        fieldRow.forEach(function (field) {
    ...
    value: function handleSubmit() {
      ...
      var fields = (0, _lodash.flatten)(this.props.fields);

      var invalidFields = fields.reduce(function (obj, field) {
        var validator = field.validator || function () {
          return null;
        };
        var errorMessage = validator(_this3.state[field.stateKey], field.label || (0, _utils.formatKey)(field.stateKey), _this3.state);
      ...
      if ((0, _keys2.default)(invalidFields).length > 0) {
        this.setState({
          formErrors: (0, _assign2.default)({}, this.state.formErrors, invalidFields)
        });
      } else {
    ...
    value: function render() {
      ...
      var firstErrorKey = (0, _keys2.default)(formErrors).find(function (k) {
        return formErrors[k];
      });

      var error = [undefined, null, -1].includes(firstErrorKey) ? globalError : formErrors[firstErrorKey];

      var stateInputParams = {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)([title && 'form--hastitle', 'form', 'rscomp', className]),
        ...
        _react2.default.createElement(
          ...
          fields.map(function (fieldRow, rowIndex) {
            return _react2.default.createElement(
              'div',
              { className: 'form__fieldrow form__fieldrow--' + rowIndex, key: rowIndex },
              fieldRow.map(function (field, index) {
                return _react2.default.createElement(_Input2.default, (0, _extends3.default)({ key: index }, stateInputParams, field));
              })
            );
          })
        ),
        typeof submitButton === 'string' ? _react2.default.createElement(
          'a',
          {
          ...
          submitButton
        ) : _react2.default.cloneElement(submitButton, { onClick: function onClick() {
            _this4.handleSubmit();
          } }),
            ...
            if (item.action && item.action instanceof Function) {
              return _react2.default.createElement(
                'li',
                {
                  ...
                  className: classes,
                  onClick: function onClick() {
                    return item.action(_this4.state);
                  }
                },
                item.label
              );
              ...
              console.error('Improper action passed to BaseForm: ' + (0, _stringify2.default)(item));
...
BaseFormUC.defaultProps = {
  submitButton: 'Submit',
  onSubmit: function onSubmit(attrs) {
    /* eslint-disable no-console */
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(67)(Function.call, __webpack_require__(125).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
 ...
 */
function InputUC(_ref) {
  var setParentState = _ref.setParentState,
      ...
      reportErrorImmediately = _ref.reportErrorImmediately,
      className = _ref.className;

  var finalLabel = label || (0, _utils.formatKey)(stateKey);
  var error = parentState.formErrors && parentState.formErrors[stateKey];
  var value = parentState[stateKey];
  ...
  var inputParams = {
    ...
    onChange: function onChange(e) {
      ...
      var validationMessage = val ? validator(val, label || (0, _utils.formatKey)(stateKey), parentState) : null;

      var changes = (0, _defineProperty3.default)({}, stateKey, val);
      ...
      if (reportErrorImmediately || !validationMessage && error) {
        changes.formErrors = (0, _assign2.default)({}, parentState.formErrors || {}, (0, _defineProperty3.default)({}, stateKey, validationMessage));
      }
  ...
  var input = _react2.default.createElement(type === 'textarea' ? 'textarea' : 'input', (0, _assign2.default)({
    className: (0, _classnames2.default)('form__input', 'form__input--' + stateKey, error && 'form__input--error', className)
  }, inputParams));

  return _react2.default.createElement(
    'label',
    { className: 'form__label' },
    ['label', 'both'].includes(labelType) && _react2.default.createElement(
      'span',
      { className: 'label' },
      finalLabel
    ),
...
function CheckboxUC(_ref) {
  ...
  var checked = checkboxes.get(boxID);
  return _react2.default.createElement(
    'label',
    { className: (0, _classnames2.default)('checkbox rscomp', className), htmlFor: boxID },
    _react2.default.createElement('input', {
      className: 'checkable__input',
      type: 'checkbox',
      onChange: function onChange() {
        dispatch((0, _actions.setCheckboxValue)(boxID, !checked));
      },
      name: name,
      checked: checked
    }),
    _react2.default.createElement('span', { className: 'checkable__mark' }),
    _react2.default.createElement(
      'span',
      { className: 'checkable__label' },
      name
    )
  );
}
...
CheckboxUC.propTypes = {
  ...
  checkboxes: _reactImmutableProptypes.map.isRequired,
  dispatch: func,
  className: string
};

exports.default = (0, _reactRedux.connect)(mapStateToProps)(CheckboxUC);
...
function DropdownUC(props) {
  ...
  var finalItems = typeof items[0] === 'string' ? items.map(function (item) {
    return { value: item, label: item };
  }) : items;

  var titleIndex = selectedIndices[0];

  var finalTitle = selectedIndices.length === 1 && replaceTitle && !multipleSelect ? finalItems[titleIndex].label : title;

  return _react2.default.createElement(
    'div',
    {
      className: (0, _classnames2.default)([open && 'dropdown--open', className, 'dropdown rscomp', multipleSelect && 'dropdown--multi']),
      style: style
    },
    _react2.default.createElement(
      'div',
      { className: 'dropdown__toggle', onClick: onTitleClick },
      _react2.default.createElement(
        'span',
        { className: 'dropdown__title' },
        finalTitle
      ),
      _react2.default.createElement('span', { className: 'dropdown__icon' })
    ),
    _react2.default.createElement(
      'div',
      { className: (0, _classnames2.default)('dropdown__menu') },
      _react2.default.createElement(
        'ul',
        null,
        finalItems.map(function (item, index) {
          return _react2.default.createElement(
            'li',
            {
              className: (0, _classnames2.default)(['dropdown__item', selectedIndices.includes(index) && 'dropdown__item--active', item.className]),
              key: index,
              onClick: function onClick() {
                return onItemClick({ index: index, value: item.value || item.label });
              }
            },
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  var dropID = ownProps.dropID;

  var open = state.openDropdownID === dropID;
  var element = state.dropdowns.get(dropID) ? state.dropdowns.get(dropID).toJS() : [];

  return {
    open: open,
    element: element,
    selectedIndices: element.map(function (obj) {
      return obj.index;
    })
  };
};

var mergeProps = function mergeProps(stateProps, _ref, ownProps) {
  var dispatch = _ref.dispatch;
  return (0, _extends3.default)({}, stateProps, ownProps, {
    element: undefined,
    onItemClick: function onItemClick(item) {
      ...
      if (ownProps.multipleSelect) {
        var previousSelections = stateProps.element;
        var preexisting = previousSelections.find(function (obj) {
          return obj.index === item.index;
        });

        toDispatch = preexisting ? [].concat((0, _toConsumableArray3.default)(previousSelections), [item]).filter(function (i) {
          return i.index !== item.index;
        }) : previousSelections.concat(item);
      }

      dispatch((0, _actions.setDropdownValues)(ownProps.dropID, toDispatch));

      // Close dropdown unless it's multiple-select
      !ownProps.multipleSelect && dispatch((0, _actions.setOpenDropdownID)(null));
    },
    onTitleClick: function onTitleClick() {
      return dispatch((0, _actions.setOpenDropdownID)(stateProps.open ? null : ownProps.dropID));
    }
  });
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, undefined, mergeProps)(DropdownUC);
...
var _isUrlExternal = __webpack_require__(298);
 ...
 */
function LinkUC(props) {
  var to = props.to,
      className = props.className,
      beforeGo = props.beforeGo,
      goInternal = props.goInternal,
      data = props.data,
      target = props.target,
      style = props.style,
  ...
  var linkProps = {
    href: to,
    className: (0, _classnames2.default)('link rscomp', className),
    onClick: function onClick(e) {
      var routeInternally = !(0, _isUrlExternal2.default)(to) && target !== '_blank';
      if (routeInternally) e.preventDefault(); // Don't follow href for internal links

      beforeGo && beforeGo();

      if (routeInternally) {
        goInternal(data ? { pathname: to, state: data } : to);
      }
    },
    style: style,
    target: target,
  ...
  return _react2.default.createElement('a', linkProps);
}

LinkUC.propTypes = {
  to: _propTypes.string.isRequired,
  className: _propTypes.string,
  beforeGo: _propTypes.func,
  data: _propTypes.object,
  goInternal: _propTypes.func,
  target: _propTypes.string,
  style: _propTypes.object,
  children: (0, _propTypes.oneOfType)([_propTypes.string, _propTypes.element])
};
...
var mapStateToProps = function mapStateToProps() {
  return {
    goInternal: _reactRouter.browserHistory.push
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps)(LinkUC);
...
exports.RadioGroupUC = RadioGroupUC;
...
function RadioGroupUC(_ref) {
  ...
  var fullItems = items.map(function (item, index) {
    var fullItem = void 0;
    ...
    if (typeof item === 'string') {
      ...
      fullItem = (0, _assign2.default)({}, item, { index: index });
    }
    return fullItem;
  });
  ...
  return _react2.default.createElement(
    'ul',
    { className: (0, _classnames2.default)('radio rscomp', className) },
    fullItems.map(function (item) {
      var selected = selectedValue === item.value;
      return _react2.default.createElement(
        'li',
        {
          className: (0, _classnames2.default)('radio__li', selected && 'radio__li--selected'),
          key: item.index,
          onClick: function onClick() {
            onCheck(item);
          }
        ...
        _react2.default.createElement(
          'label',
          { className: 'radio__label', htmlFor: item.value },
          _react2.default.createElement('input', {
          ...
          _react2.default.createElement('span', { className: 'radio__mark' }),
          _react2.default.createElement(
            'span',
        ...
        item.tag && _react2.default.createElement(
          'span',
          { className: 'radio__tag' },
          item.tag
        )
      );
    })
...
var mergeProps = function mergeProps(stateProps, _ref3, ownProps) {
  var dispatch = _ref3.dispatch;
  return (0, _extends3.default)({}, stateProps, ownProps, {
    onCheck: function onCheck(item) {
      dispatch((0, _actions.setRadioValue)(ownProps.groupID, item));
      ownProps.afterCheck && ownProps.afterCheck(ownProps.groupID, item);
    }
  });
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, undefined, mergeProps)(RadioGroupUC);
